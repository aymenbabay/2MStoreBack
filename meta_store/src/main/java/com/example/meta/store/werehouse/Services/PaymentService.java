...
public class PaymentService extends BaseService<Payment, Long>{
	...
	public List<PaymentDto> getAllMy(Client client){
		List<Payment> payments = paymentRepository.findAllByCompanyIdOrClientId(client.getCompany().getId(), client.getId());
		if(payments.isEmpty()) {
